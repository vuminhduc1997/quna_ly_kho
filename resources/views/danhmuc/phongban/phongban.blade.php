...
<div class="span16" >
        <div class="box-header">
            <div class="row">
                <div class="span11">
                    <fieldset>
                        <a href="{!! URL::route('danhmuc.phongban.getAdd') !!}" class="btn btn-info"><i class="icon-plus"></i>&nbspThêm</a>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tr>
                    ...
                    <td>{!! $item->pb_ten !!}</td>
                    <td class="td-actions">
                        <a href="{!! URL::route('danhmuc.phongban.getEdit' , $item->id) !!}" class="btn btn-small btn-info"><i class="btn-icon-only icon-edit"></i></a>

                        <a href="{!! URL::route('danhmuc.phongban.getDelete',$item->id) !!}" class="btn btn-small btn-danger">
