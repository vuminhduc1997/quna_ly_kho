                ...
                <div id="acct-password-row" class="span7">
                    <fieldset>
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                <input id="current-pass-control" name="txtMa" class="span4" type="text" disabled="true" value="{!! $nhasanxuat->nsx_ma !!}">
                                <div>
                                    {!! $errors->first('txtMa') !!}
                                </div>
                            </div>
                        ...
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                <input id="new-pass-control" name="txtTen" class="span4" type="text" value="{!! $nhasanxuat->nsx_ten !!}">
                                <div>
                                    {!! $errors->first('txtTen') !!}
                                </div>
                            </div>
                        ...
                        <div class="control-group ">
                                ...
                                <div class="controls">
                                    <select name="selKV" id="input" class="form-control">
                                        ...
                                        <?php Select_Function($khuvuc,$nhasanxuat->kv_id); ?>
                                    </select>
                                    <div>
                                        {!! $errors->first('selKV') !!}
                                    </div>
                    ...
                    <footer id="submit-actions" class="form-actions">
                        ...
                        <a href="{!! URL::route('danhmuc.nhasanxuat.getList') !!}" class="btn"><i class="icon-remove"></i>&nbsp&nbspHủy&nbsp&nbsp</a>
                    </footer>
                </div>
            </form>
        </div>
