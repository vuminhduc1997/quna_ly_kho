            ...
            <div id="acct-password-row" class="span7">
                <fieldset>
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input id="current-pass-control" name="txtMa" class="span4" type="text" disabled="true" value="{!! $data->cl_ma !!}">
                            <div>
                                {!! $errors->first('txtMa') !!}
                            </div>
                        </div>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input id="new-pass-control" name="txtTen" class="span4" type="text" value="{!! $data->cl_ten !!}">
                            <div>
                                {!! $errors->first('txtTen') !!}
                            </div>
                        </div>
                ...
                <footer id="submit-actions" class="form-actions">
                    <button id="submit-button" type="submit" class="btn btn-primary" name="action" value="CONFIRM"><i class="icon-save"></i>&nbsp&nbspLưu&nbsp&nbsp</button>
                        <a href="{!! URL::route('danhmuc.chatluong.getList') !!}" class="btn"><i class="icon-remove"></i>&nbsp&nbspHủy&nbsp&nbsp</a>
                </footer>
            </div>
            </form>
        </div>
