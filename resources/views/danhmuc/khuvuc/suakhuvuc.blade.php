            ...
            <div id="acct-password-row" class="span7">
                <fieldset>
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input id="current-pass-control" name="txtMa" class="span4" type="text" disabled="true" value="{!! $data->kv_ma !!}">
                            <div>
                                {!! $errors->first('txtMa') !!}
                            </div>
                        </div>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <input id="new-pass-control" name="txtTen" class="span4" type="text" value="{!! $data->kv_ten !!}">
                            <div>
                                {!! $errors->first('txtTen') !!}
                            </div>
                        </div>
