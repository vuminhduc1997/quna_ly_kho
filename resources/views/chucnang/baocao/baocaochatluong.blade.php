    ...
    <div style="margin-left:-1px" class="span13">
        <div class="box">
            <div class="box-header">
                <p><b>Tồn kho theo chất lượng vật tư</b></p>
            </div>
                                ...
                                <table class="table table-bordered table-hover tablesorter" id="sample-table">
                                    ...
                                    @foreach ($data as $item)
                                        <?php 
                                            ...
                                            ?>
                                        <tr>
                                            <td colspan="9" style="color:red;"><b>Chất lượng vật tư: {!! $item->cl_ten !!} | SL vật tư: {{$count}} | Tổng giá trị: {!! number_format($tong,0,".",",")  !!} vnđ</b></td>
                                        </tr>
