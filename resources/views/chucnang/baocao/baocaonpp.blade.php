    ...
    <div style="margin-left:-1px" class="span13">
        <div class="box">
            <div class="box-header">
                <p><b>Tồn kho theo nhà phân phối</b></p>
            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div style="margin-left:auto;" >
                                <table class="table table-bordered table-hover tablesorter" id="sample-table"  style="width:100%">
                                    ...
                                    @foreach ($data as $item)
                                        <?php 
                                            ...
                                            ?>
                                        <tr>
                                            <td colspan="9" style="color:red;"><b>Nhà phân phối: {!! $item->npp_ten !!} | SL vật tư: {{$count}} | Tổng giá trị: {!! number_format($tong,0,".",",")  !!} vnđ</b></td>
                                        </tr>
