...
<head>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a href="{!! URL('home') !!}" class="brand">
                        <img src="{{ url('public/lib/images/logoevn.png')}}" width="30px" height="50px" style="margin-top:-4px">EVN SPC 
                    </a>
        ...
        <footer class="application-footer">
            <div class="container">
                        <b> <p>Công ty điện lực TP XXX</p></b>
                        <div class="disclaimer">
                            <p>Địa chỉ: Số 06 xxxxxxxx</p>
                            <p>Điện thoại:0868896944 - Fax: 0868896944;  Email: vuminhduc22011997@gmail.com</p>
                        </div>
            </div>
        </footer>
	</body>
